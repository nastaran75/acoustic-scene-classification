...
def train(depth,dataset_name,nonL,fold,division,augment,patience,representation,epochs,learning_rate,batch_size,dropout,growth_rate):
	...
	network = Network.build_densenet(input_shape=(None,1,X_train.shape[1]/division),input_var=input_var,depth = depth,dropout=dropout,growth_rate=growth_rate,nonL=nonL)
