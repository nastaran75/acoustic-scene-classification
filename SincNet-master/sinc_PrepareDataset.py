...
def load_dataset(dataset_name='2channel2016_madmom',fold_number=1,representation='Mid',division=150,random_sample=False):
...
def iterate_minibatches(inputs, targets, batch_size,num_samples=150,division=150, shuffle = False,noise=False,mixup=False,val=False):
	# print inputs.shape
	# mixup_length = 0
	# if mixup:
	# 	mixup_length = 2
