...
def load_testset(dataset_name,fold_number,division,representation,random_sample=False):
...
def load_valset(dataset_name,fold_number,division,representation,random_sample=False):
...
def iterate_minibatches(inputs, targets, batch_size,num_samples,division, shuffle = False,noise=False,mixup=False,val=False):
	...
	if mixup:
		...
		for i in range(inputs.shape[0]*45):
			# print i
